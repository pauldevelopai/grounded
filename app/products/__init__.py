...
- Editions: Different versions of the same product (AI Toolkit V1, V2, etc.)
...
Usage:
    ...
    aitoolkit = get_product("aitoolkit")
    current_edition = get_active_edition("aitoolkit")

    # Check if an edition is sealed
    v1 = get_edition("aitoolkit", "v1")
    if v1.is_sealed:
